...
1. Version name wasn't saved on download. The download function used the stale form variabled before patchDraft could update the content. I changed the patchDraft to update draft useStates and called the form value after the function ran to get the latest version name.
